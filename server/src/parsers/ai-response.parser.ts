...
export type ParsedGeneratedPaper = z.infer<typeof generatedPaperResponseSchema>;

export const parseGeneratedPaperResponse = (rawResponse: string): ParsedGeneratedPaper => {
