...
export const generateQuestionPaperFromAI = async (args) => {
    ...
    if (!env.OPENAI_API_KEY) {
        return {
            ...
            response: JSON.stringify({
                ...
                answerKey: args.assignment.questionTypes.flatMap((questionType, typeIndex) => Array.from({ length: questionType.count }, (_, questionIndex) => ({
                    question: `${questionType.label} question ${questionIndex + 1} on ${args.assignment.subject}.`,
                    answer: `Sample answer for ${questionType.label} ${questionIndex + 1}`,
